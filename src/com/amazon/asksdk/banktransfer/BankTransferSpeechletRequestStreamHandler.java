 ...
 */
public final class BankTransferSpeechletRequestStreamHandler extends
    ...
    public BankTransferSpeechletRequestStreamHandler() {
        super(new BankTransferSpeechlet(), supportedApplicationIds);
    }
}
