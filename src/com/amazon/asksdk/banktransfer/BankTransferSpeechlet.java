 ...
 */
package com.amazon.asksdk.banktransfer;
 ...
 */
public class BankTransferSpeechlet implements SpeechletV2 {
    private static final Logger log = LoggerFactory.getLogger(BankTransferSpeechlet.class);
    ...
    private SpeechletResponse getRecipe(Intent intent) {
        ...
        if (itemSlot != null && itemSlot.getValue() != null) {
            ...
            String recipe = BankInfo.get(itemName);
